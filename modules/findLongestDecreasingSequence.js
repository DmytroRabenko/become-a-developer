...
- якщо поточна послідовність порожня або поточне число менше попереднього, 
...
function findLongestDecreasingSequence(fileName) {
...
module.exports = findLongestDecreasingSequence;
